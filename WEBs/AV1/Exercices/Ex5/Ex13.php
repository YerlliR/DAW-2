...
<html lang="es">
    ...
    <body>
        ...
        <form action="./SergioRicartForm1OK.php" method="get">
            ...
            <label for="aceptacion" id="aceptacion">Declaro haber leído y aceptar las condiciones generales del programa y la normativa sobre protección de datos</label>
            <br>
            <br>
